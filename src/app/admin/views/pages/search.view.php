<web:frame title="Search">
    <utils:arrayItem output="field" key-id="page-tlstart" key-name="Page (tag lib start)" />
    <utils:arrayItem output="field" key-id="page-tlend" key-name="Page (tag lib end)" />
    <utils:arrayItem output="field" key-id="page-head" key-name="Page (head)" />
    <utils:arrayItem output="field" key-id="page-content" key-name="Page (content)" />
    <utils:arrayItem output="field" key-id="template-content" key-name="Template (content)" />
    <utils:arrayItem output="field" key-id="textfile-content" key-name="Text File (content)" />

    <edit:form submit="search">
        <ui:filter session="field">
            <div class="gray-box">
                <label for="query" class="w100">Text:</label>
                <ui:textbox name="q" id="query" class="w500" />
            </div>
            <div class="gray-box">
                <label class="w100">Field:</label>
                <ui:checkboxlist name="field" source="utils:field" display="name" value="id" repeat="horizontal" class="mr-1" />
            </div>
            <div class="gray-box">
    ...
    <web:condition when="query:q">
        <p:search text="query:q" location="session:field">
            ...
            <ui:grid items="p:searchList" class="data-table standart wmax">
                ...
                <ui:column header="Field" th-class="w40" value="p:searchSubType" />
