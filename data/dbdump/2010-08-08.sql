...
--
-- Počítač: localhost
-- Vygenerováno: Neděle 08. srpna 2010, 15:44
-- Verze MySQL: 5.1.37
-- Verze PHP: 5.3.0
...
--
-- Vypisuji data pro tabulku `article_line_right`
--
...
--
-- Vypisuji data pro tabulku `customform`
--
...
--
-- Struktura tabulky `db_connection`
--
...
--
-- Vypisuji data pro tabulku `db_connection`
--
...
--
-- Vypisuji data pro tabulku `directory_right`
--
...
--
-- Vypisuji data pro tabulku `file_right`
--
...
--
-- Vypisuji data pro tabulku `form_order1`
--
...
--
-- Vypisuji data pro tabulku `form_order2`
--
...
--
-- Struktura tabulky `pair_uid_property`
--
...
--
-- Vypisuji data pro tabulku `pair_uid_property`
--
...
--
-- Struktura tabulky `personal_note`
--
...
--
-- Vypisuji data pro tabulku `personal_note`
--
...
--
-- Struktura tabulky `personal_property`
--
...
--
-- Vypisuji data pro tabulku `personal_property`
--
...
--
-- Struktura tabulky `universal_permission`
--
...
--
-- Vypisuji data pro tabulku `universal_permission`
--
...
--
-- Vypisuji data pro tabulku `web_alias`
--
...
--
-- Struktura tabulky `window_properties`
--
...
--
-- Vypisuji data pro tabulku `window_properties`
--
...
--
-- Vypisuji data pro tabulku `wp_wysiwyg_file`
--
...
--
-- Struktura tabulky `w_projection`
--
...
--
-- Vypisuji data pro tabulku `w_projection`
--
...
--
-- Vypisuji data pro tabulku `w_reference`
--
...
--
-- Struktura tabulky `w_sport_project`
--
...
--
-- Vypisuji data pro tabulku `w_sport_project`
--
...
--
-- Struktura tabulky `w_sport_round`
--
...
--
-- Vypisuji data pro tabulku `w_sport_round`
--
...
--
-- Struktura tabulky `w_sport_tables`
--
...
--
-- Vypisuji data pro tabulku `w_sport_tables`
--
