...
--
-- Poèítaè: localhost
-- Vygenerováno: Pátek 27. února 2009, 22:25
-- Verze MySQL: 5.1.30
-- Verze PHP: 5.2.8
...
(9, 1, '<php:register tagPrefix="user" classPath="php.libs.User" />', '<php:unregister tagPrefix="user" />', '', '<p>\r\n	<user:management />\r\n</p>'),
(10, 1, '<php:register tagPrefix="fl" classPath="php.libs.File" />', '<php:unregister tagPrefix="fl" />', '', '<web:content />'),
(11, 1, '', '', '', '<fl:get />'),
(12, 1, '', '', '', '<web:content />'),
(13, 1, '', '', '', '<web:textFile type="css" />'),
(14, 1, '', '', '', '<web:content />'),
(15, 1, '', '', '', '<web:textFile type="js" />'),
(1, 1, '', '', '', '<h2>Welcome</h2>\r\n<p>\r\nSorry ... but this web site is currently underconstruction. Thanks\r\n</p>'),
(16, 1, '<php:register tagPrefix="artc" classPath="php.libs.Article" />', '<php:unregister tagPrefix="artc" />', '', '<p>\r\n	<artc:process />\r\n</p>\r\n<p>\r\n	<artc:setLine method="get" />\r\n</p>\r\n<p>\r\n	<artc:showManagement />\r\n</p>\r\n<p>\r\n	<artc:showLines editable="true" />\r\n</p>\r\n<p>\r\n	<artc:createLine />\r\n</p>'),
...
(23, 1, '<php:register tagPrefix="pg" classPath="php.libs.Page" />', '<php:unregister tagPrefix="pg" />', '', '<pg:clearUrlCache />\r\n<pg:updateKeywords />\r\n<pg:showLanguages editable="true" />'),
(1, 0, '', '', NULL, '<h2>Welcome</h2>\r\n<p>\r\nSorry ... but this web site is currently underconstruction. Thanks\r\n</p>');
...
INSERT INTO `group` (`gid`, `name`, `value`) VALUES
(1, 'admins', 1),
(2, 'web-admins', 50),
(3, 'web', 254);
...
(1, 1, 'Welcome', 0, '', 0, 1, 1, '', 1235766135),
(2, 1, 'CMS', 1, 'cms', 0, 2, 1, '', 1234554118),
(3, 1, 'Index', 0, '', 0, 3, 1, '', 1232545364),
(4, 1, 'Login', 1, 'login', 0, 4, 1, '', 1232545364),
(5, 1, 'in', 0, 'in', 1, 5, 1, '', 1234389400),
(6, 1, 'Page Manager', 1, 'page-manager', 1, 6, 1, '', 1234389321),
(7, 1, 'Text File Manager', 1, 'text-file-manager', 1, 7, 1, '', 1233078739),
(8, 1, 'File Manager', 1, 'file-manager', 1, 8, 1, '', 1233078749),
(9, 1, 'User Manager', 1, 'user-manager', 1, 9, 1, '', 1233078763),
(10, 1, 'File', 1, 'file', 0, 10, 1, '', 1233771181),
(11, 1, 'Get File', 1, '<fl:compose />', 0, 11, 1, '', 1233771197),
(12, 1, 'CSS', 1, 'css', 0, 12, 1, '', 1233771214),
(13, 1, 'Get CSS', 1, '<web:composeTextFileUrl />', 0, 13, 1, '', 1233771224),
(14, 1, 'JS', 1, 'js', 0, 14, 1, '', 1233771232),
(15, 1, 'Get JS', 1, '<web:composeTextFileUrl />', 0, 15, 1, '', 1233771241),
(16, 1, 'Article Manager', 1, 'article-manager', 1, 16, 1, '', 1233078775),
(17, 1, 'Guestbook Manager', 1, 'guestbook-manager', 1, 17, 1, '', 1234282979),
(23, 1, 'Web Settings', 1, 'web-settings', 1, 23, 1, '', 1235767722);
...
INSERT INTO `page` (`id`, `parent_id`) VALUES
(1, 0),
(2, 0),
(3, 2),
(4, 2),
...
--
-- Vypisuji data pro tabulku `urlcache`
--
...
INSERT INTO `user` (`uid`, `group_id`, `name`, `surname`, `login`, `password`) VALUES
(1, 1, 'admin', 'admin', 'admin', 'b49a387e1143eccc5d6cb585d49290c2e2a85145'),
(2, 0, 'HTML', 'koder', 'htmlkoder', 'e72aef7f14a3e8348ca7930b5f8b008b0ba94d2e');
