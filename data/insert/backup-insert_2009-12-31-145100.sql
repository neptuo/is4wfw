...
--
-- Host: localhost
-- Generation Time: Dec 30, 2009 at 02:50 PM
...
CREATE TABLE IF NOT EXISTS `template` (
  ...
  `content` text COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=39 ;
...
CREATE TABLE IF NOT EXISTS `urlcache` (
  ...
  `wp` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=250 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=618 ;
