    ...
    public function showEditForm($showNotSelectedError = false) {
        ...
        if ($_POST['edit'] == $rb->get('project.edit') || $_POST['new-project'] == $rb->get('project.create')) {
            ...
            $return .= ''
                    ...
                    . '</div>'
                    . '<div class="gray-box">'
                    . '<label class="w100" for="project-edit-error-all-' . $project['id'] . '">' . $rb->get('project.allerror') . ':</label> '
                    . '<select class="w300" id="project-edit-error-all-' . $project['id'] . '" name="project-errors-all">' . $project['error-all-options'] . '</select>'
                    . '</div>'
                    . '<div class="gray-box">'
                    . '<label class="w100" for="project-edit-error-404-' . $project['id'] . '">' . $rb->get('project.error404') . ':</label> '
                    . '<select class="w300" id="project-edit-error-404-' . $project['id'] . '" name="project-errors-404">' . $project['error-404-options'] . '</select>'
                    . '</div>'
                    . '<div class="gray-box">'
                    . '<label class="w100" for="project-edit-error-403-' . $project['id'] . '">' . $rb->get('project.error403') . ':</label> '
