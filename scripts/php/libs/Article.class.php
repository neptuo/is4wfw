                    ...
                    if (self::canUser($articleContent['line_old_id'], WEB_R_WRITE)) {
                        ...
                        if (count($artc) == 0) {
                            ...
                            if (count($artc) == 0) {
                                ...
                                $dbObject->execute("INSERT INTO `article_content`(`article_id`, `name`, `url`, `keywords`, `head`, `content`, `author`, `timestamp`, `datetime`, `language_id`) VALUES (" . $ac['article_id'] . ", \"" . $dbObject->escape($ac['name']) . "\", \"" . $dbObject->escape($ac['url']) . "\", \"" . mysql_real_escape_string($ac['keywords']) . "\", \"" . mysql_real_escape_string($ac['head']) . "\", \"" . mysql_real_escape_string($ac['content']) . "\", \"" . mysql_real_escape_string($ac['author']) . "\", " . $ac['timestamp'] . ", \"" . mysql_real_escape_string($ac['datetime']) . "\", " . $ac['language_id'] . ");");
